    ...
    return (
        <div>
            ...
            <div className='w-full flex flex-col gap-4'>
                <div className='w-1/2'>
                <Select invalidFields={invalidFields} setinvalidFields={setinvalidFields} value={payload.categoryCode} setValue={setPayload} name='categoryCode' options={categories} label='Loại chuyên mục' />
                </div>
                ...
                <div className='w-1/2 flex flex-col gap-4'>
                    ...
                    setValue={setPayload} name='target'  options={targets} label='Đối tượng cho thuê' />
                </div>
            </div>
